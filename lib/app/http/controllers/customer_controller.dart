import 'package:paml/app/models/customer.dart';
...
class CustomerController extends Controller {
  ...
  Future<Response> store(Request request) async {
    ...
    if (cust != null) {
      return Response.json({
        'success': false,
        'message': 'Customer with phone number $custTelp already exists'
      }, 401);
    }
    ...
    return Response.json(
        {'success': true, 'message': 'Data has been saved', 'data': data});
  }
  ...
  Future<Response> show(String id) async {
    ...
    if (customer == null) {
      return Response.json(
          {'success': false, 'message': 'Customer with id $id not found'}, 404);
    }
    return Response.json({
      'success': true,
      'message': 'Data has been loaded',
  ...
  Future<Response> update(Request request, String id) async {
    ...
    return Response.json(
        {'success': true, 'message': 'Data has been updated', 'data': data});
  }
